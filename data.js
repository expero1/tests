const rawData = [
  ...
  "7. Часом у мене бувають напади сміху або плачу, з якими я ніяк не можу впоратись.",
  ...
  "14. В дитинстві я скоював дрібні крадіжки.",
  ...
  "17. Сон у мене переривчатий і неспокійний.",
  "18. Моя сім’я відноситься з несхваленням до тієї роботи, яку я обрав.",
  ...
  "24. Зустрічаючи на вулиці своїх знайомих або шкільних друзів, з якими я давно не бачився, я вважаю за краще проходити осторонь від них, якщо вони зі мною не заговорюють першими.",
  ...
  "33. Я вважаю, що більшість людей здатна збрехати, щоб просунутись по службі.",
  ...
  "40. Іноді, коли я не добре себе відчуваю я буваю дратівливим.",
  ...
  "44. Моя мова зараз така ж як завжди (не швидше і не повільніше, немає ні хрипоти, ні виразності).",
  "45. Я вважаю, що моє сімейне життя таке ж добре, як у більшості моїх знайомих.",
  "46. Мене вкрай зачіпає, коли мене критикують або сварять.",
  ...
  "56. Я вважаю, що часто мене карали несправедливо.",
  "57. Я легко можу розплакатись.",
  "58. Я мало стомлююся.",
  ...
  "71. Бували випадки, що мені було важко утриматися від того, щоб що-небудь не поцупити в кого-небудь або де-небудь, наприклад у магазині",
  "72. Я зловживав спиртними напоями.",
  "73. Я часто про що-небудь турбуюся.",
  "74. Мені б хотілося бути членом декількох гуртків або зборів.",
  ...
  "82. Мої батьки і (або) інші члени моєї сім’ї прискіпуються до мене більше, ніж потрібно.",
  "83. Хтось керує моїми думками.",
  "84. Люди байдужі до того, що з тобою може трапитися.",
  ...
  "99. Я дуже рідко починаю розмову з людьми першим.",
  ...
  "112. Іноді у мене бувають напади сміху або плачу, з якими я ніяк не можу впоратись.",
  ...
  "129. Часто мені неприємно, коли я намагаюся застерегти кого-небудь від помилок, а мене розуміють невірно.",
  ...
  "139. Мене дуже турбують різні нещастя.",
  ...
  "152. Якщо я поганої думки про людину або навіть зневажаю її, я мало прагну приховати це від неї.",
  ...
  "159. Я люблю бувати на вечірках і просто в компаніях.",
  "160. Я прагну ухилитися від конфліктів і скрутних ситуацій.",
  ...
  "163. Якщо я захочу зробити щось, але оточуючі вважають, що цього робити не варто, я можу легко відмовитися від своїх намірів.",
  ...
  "170. Тим правилам, які, на мій погляд, несправедливі, я завжди прагну протидіяти.",
  ...
  "174. Я сумніваюся, що зможу зі своїм здоров’ям витримати всі навантаження військової служби.",
  ...
  "178. Мені хотілося б служити у ВДВ або частинах спеціального призначення.",
  "179. Із службою у мене нічого не виходить (не “клеїться”). Часто думаю: “не моя це справа”.",
  ...
  "186. Я впевнений, що в майбутньому не стану укладати або продовжувати контракт на продовження військової служби.",
  "187. У мене бувають періоди похмурої дратівливості, під час яких я “зриваю злість” на оточуючих.",
  "188. Я насилу витримую фізичні навантаження, пов’язані з моєю професійною діяльністю.",
  "189. Я достатньо спокійно ставлюся до необхідності брати участь в тривалих і небезпечних відрядженнях.",
  "190. Навряд чи я схочу присвятити все своє життя військовій професії (продовжити контракт, залишитися на службу за контрактом, вступити до військового навчального закладу).",
  ...
  "199. Можна погодитися з тим, що я не дуже схильний виконувати багато наказів, вважаючи їх безрозсудними.",
...
const surveyJson = (() => {
        ...
        elements: [
          {
            type: "html",
            name: "instruction ",
            html: `<div class="survey-title"><h1 >Багаторівневий особистісний опитувальник (БОО) “Адаптивність-200”</h1>
		              <p><h2>Інструкція:</h2></p>
                  <p>“Опитувальник складається з тверджень, що стосуються Вашого самопочуття, поведінки,
                    характеру, інтересів і відносин в родині.</p>
                  <p>Ваше завдання полягає у тому, щоб визначити своє відношення до кожного твердження, тобто погодитися або не
                    погодитися з ним.</p>
                  <p><b>Якщо Ви погоджуєтеся з твердженням, то дайте відповідь “так”.</b></p>
                  <p><b>Якщо Ви не згодні – відповідь “ні”.</b></p>
                  <p>Правильних або неправильних відповідей тут бути не може, тому довго не замислюйтеся над питанням – давайте
                    відповідь,виходячи з того, що більше відповідає Вашому характеру або уявленню про самого себе”.</p></div>`,
          },
          {
            type: "text",
  ...
  result.pages[0].elements.push({
    ...
    choices: [
      {
        value: "Згоден на обробку персональних даних",
